...
inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kNonImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnActiveSnapshotCount("AnnActiveSnapshotCount",
                                     "In memory ANN snapshots count");

inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kNonImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnSnapshotLoadSuccessCount(
        "AnnSnapshotLoadSuccessCount",
        "Succeeded load tries for ANN snapshots");

inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kNonImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnSnapshotLoadErrorCount("AnnSnapshotLoadErrorCount",
                                        "Failed load tries for ANN snapshots");

inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kNonImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnSnapshotLoadExpiredCount(
        "AnnSnapshotLoadExpiredCount", "Tries to load not fresh ANN snapshots");

inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnHookTotalKeysCallCount(
        "AnnHookTotalKeysCallCount",
        "Total number of keys goes to getNearestNeighbors hook calls",
        kCounterDPUpperBound, kCounterDPLowerBound);

inline constexpr privacy_sandbox::server_common::metrics::Definition<
    int, privacy_sandbox::server_common::metrics::Privacy::kImpacting,
    privacy_sandbox::server_common::metrics::Instrument::kUpDownCounter>
    kMicrosoftAnnHookErrorsCallCount(
        "AnnHookErrorsCallCount",
        "Number of getNearestNeighbors hook calls where there are "
        "invalid keys or results",
        kCounterDPUpperBound, kCounterDPLowerBound);
...
inline constexpr privacy_sandbox::server_common::metrics::Definition<
    ...
    kMicrosoftAnnGetKeyValueSetLatencyInMicros(
        "AnnGetKeyValueSetLatencyInMicros",
        "getNearestNeighbors GetKeyValueSet execution time",
        kLatencyInMicroSecondsBoundaries, kMicroSecondsUpperBound,
        kMicroSecondsLowerBound);
...
#if defined(MICROSOFT_AD_SELECTION_BUILD)
        &kDeleteUInt64ValueSetLatency, &kMicrosoftAnnActiveSnapshotCount,
        &kMicrosoftAnnSnapshotLoadSuccessCount,
        &kMicrosoftAnnSnapshotLoadErrorCount,
        &kMicrosoftAnnSnapshotLoadExpiredCount};
#else
...
#if defined(MICROSOFT_AD_SELECTION_BUILD)
        &kInternalGetUInt64ValueSetLatencyInMicros,
        &kMicrosoftAnnHookTotalKeysCallCount, &kMicrosoftAnnHookErrorsCallCount,
        &kMicrosoftAnnGetKeyValueSetLatencyInMicros};
#else
        &kInternalGetUInt64ValueSetLatencyInMicros};
#endif  // defined(MICROSOFT_AD_SELECTION_BUILD)
